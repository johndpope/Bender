    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 1...4:
          ...
          self.kind = try Tensorflow_Magenta_GeneratorOptions.ArgValue.OneOf_Kind(byDecodingFrom: &decoder, fieldNumber: fieldNumber)
        default: break
        }
      }
    }
...
public struct Tensorflow_Magenta_GeneratorBundle: SwiftProtobuf.Message {
  ...
  public var hasGeneratorDetails: Bool {
    return _storage._generatorDetails != nil
  }
  public mutating func clearGeneratorDetails() {
    _storage._generatorDetails = nil
  }
  ...
  public var hasBundleDetails: Bool {
    return _storage._bundleDetails != nil
  }
  public mutating func clearBundleDetails() {
    _storage._bundleDetails = nil
  }
...
extension Tensorflow_Magenta_GeneratorOptions.ArgValue.OneOf_Kind {
