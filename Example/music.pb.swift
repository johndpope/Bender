...
fileprivate struct _GeneratedWithProtocGenSwiftVersion: SwiftProtobuf.ProtobufAPIVersionCheck {
  struct _1: SwiftProtobuf.ProtobufAPIVersion_2 {}
...
public struct Tensorflow_Magenta_NoteSequence: SwiftProtobuf.Message {
  ...
  public var hasSourceInfo: Bool {
    return _storage._sourceInfo != nil
  }
  public mutating func clearSourceInfo() {
    _storage._sourceInfo = nil
  }
  ...
  public var hasQuantizationInfo: Bool {
    return _storage._quantizationInfo != nil
  }
  public mutating func clearQuantizationInfo() {
    _storage._quantizationInfo = nil
  }
  ...
  public var hasSubsequenceInfo: Bool {
    return _storage._subsequenceInfo != nil
  }
  public mutating func clearSubsequenceInfo() {
    _storage._subsequenceInfo = nil
  }
  ...
  public struct Note: SwiftProtobuf.Message {
    ...
    public var pitchName: Tensorflow_Magenta_NoteSequence.PitchName = Tensorflow_Magenta_NoteSequence.PitchName.unknownPitchName
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
      ...
      if self.pitchName != Tensorflow_Magenta_NoteSequence.PitchName.unknownPitchName {
  ...
  public struct KeySignature: SwiftProtobuf.Message {
    ...
    public var key: Tensorflow_Magenta_NoteSequence.KeySignature.Key = Tensorflow_Magenta_NoteSequence.KeySignature.Key.c

    public var mode: Tensorflow_Magenta_NoteSequence.KeySignature.Mode = Tensorflow_Magenta_NoteSequence.KeySignature.Mode.major
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
      ...
      if self.key != Tensorflow_Magenta_NoteSequence.KeySignature.Key.c {
        try visitor.visitSingularEnumField(value: self.key, fieldNumber: 2)
      }
      if self.mode != Tensorflow_Magenta_NoteSequence.KeySignature.Mode.major {
  ...
  public struct SourceInfo: SwiftProtobuf.Message {
    ...
    public var sourceType: Tensorflow_Magenta_NoteSequence.SourceInfo.SourceType = Tensorflow_Magenta_NoteSequence.SourceInfo.SourceType.unknownSourceType

    /// The encoding type used in the source file.
    public var encodingType: Tensorflow_Magenta_NoteSequence.SourceInfo.EncodingType = Tensorflow_Magenta_NoteSequence.SourceInfo.EncodingType.unknownEncodingType

    /// That parser that was used to parse the source file.
    public var parser: Tensorflow_Magenta_NoteSequence.SourceInfo.Parser = Tensorflow_Magenta_NoteSequence.SourceInfo.Parser.unknownParser
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
      if self.sourceType != Tensorflow_Magenta_NoteSequence.SourceInfo.SourceType.unknownSourceType {
        try visitor.visitSingularEnumField(value: self.sourceType, fieldNumber: 1)
      }
      if self.encodingType != Tensorflow_Magenta_NoteSequence.SourceInfo.EncodingType.unknownEncodingType {
        try visitor.visitSingularEnumField(value: self.encodingType, fieldNumber: 2)
      }
      if self.parser != Tensorflow_Magenta_NoteSequence.SourceInfo.Parser.unknownParser {
  ...
  public struct TextAnnotation: SwiftProtobuf.Message {
    ...
    public var annotationType: Tensorflow_Magenta_NoteSequence.TextAnnotation.TextAnnotationType = Tensorflow_Magenta_NoteSequence.TextAnnotation.TextAnnotationType.unknown
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
      ...
      if self.annotationType != Tensorflow_Magenta_NoteSequence.TextAnnotation.TextAnnotationType.unknown {
  ...
  public struct QuantizationInfo: SwiftProtobuf.Message {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 1, 2:
          ...
          self.resolution = try Tensorflow_Magenta_NoteSequence.QuantizationInfo.OneOf_Resolution(byDecodingFrom: &decoder, fieldNumber: fieldNumber)
        default: break
        }
      }
    }
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
      try self.resolution?.traverse(visitor: &visitor)
      try unknownFields.traverse(visitor: &visitor)
    }
  }
...
extension Tensorflow_Magenta_NoteSequence.QuantizationInfo.OneOf_Resolution {
  fileprivate init?<T: SwiftProtobuf.Decoder>(byDecodingFrom decoder: inout T, fieldNumber: Int) throws {
    switch fieldNumber {
    case 1:
      var value = Int32()
      try decoder.decodeSingularInt32Field(value: &value)
      self = .stepsPerQuarter(value)
      return
    case 2:
      var value = Int32()
      try decoder.decodeSingularInt32Field(value: &value)
      self = .stepsPerSecond(value)
      return
    default:
      break
    }
